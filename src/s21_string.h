...
int o_to_string(struct forms *p, char *str, va_list ap);
int x_to_string(struct forms *p, char *str, va_list ap);
...
int string_to_d(struct forms *p, char *str, va_list ap);
int s21_sscanf(char *str, const char *format, ...);
int check_for_type(struct forms *p, char *str, va_list ap, int *shift);
int string_to_s(struct forms *p, char *str, va_list ap);
int string_to_c(struct forms *p, char *str, va_list ap);
int string_to_i(struct forms *p, char *str, va_list ap);
int string_to_f(struct forms *p, char *str, va_list ap);
double check_e(char *buffer, double num);
int string_to_x(struct forms *p, char *str, va_list ap);
int string_to_o(struct forms *p, char *str, va_list ap);
int string_to_p(struct forms *p, char *str, va_list ap);
int check_for_p(char *buffer);
...
void s21_itoa(long int m, char *str);
...
void s21_itoa_unsigned(unsigned long int num, char *buffer);
